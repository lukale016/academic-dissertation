...
public record DoctorPostDto(string Username, string Password, string SkypeId, string Name, string MiddleName, string Surname, string Gender, DateTime DateOfBirth, string Specialization);
public record PatientPostDto(string Username, string Password, string SkypeId, string Name, string MiddleName, string Surname, string Gender, DateTime DateOfBirth);
...
public record struct MyConnection(string Username, string FullName, string SkypeId);
